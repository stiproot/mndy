...
import type { UpdateIssueInput } from "github-core";
 ...
 */
export function registerUpdateIssueTool(server: McpServer, run: ToolRunner): void {
  server.registerTool(
    "github_update_issue",
    {
    ...
    (args) => {
      ...
      return run(updateIssueEffect(input));
    }
  );
}
