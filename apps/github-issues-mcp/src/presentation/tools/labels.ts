...
import type { AddLabelsInput, RemoveLabelInput } from "github-core";
 ...
 */
export function registerAddLabelsTool(server: McpServer, run: ToolRunner): void {
  server.registerTool(
    "github_add_labels",
    {
    ...
    (args) => {
      ...
      return run(addLabelsEffect(input));
    }
  );
}
 ...
 */
export function registerRemoveLabelTool(server: McpServer, run: ToolRunner): void {
  server.registerTool(
    "github_remove_label",
    {
    ...
    (args) => {
      ...
      return run(removeLabelEffect(input));
    }
  );
}
