...
import { GitHubApiError, GitHubRateLimitError } from "../domain/errors.js";

/** GitHub credentials. An empty token still works for public repos, at a far lower rate limit. */
