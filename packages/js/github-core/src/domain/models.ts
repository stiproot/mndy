/**
 * The GitHub issues domain.
 *
 * Effect Schema here describes data arriving from the GitHub API, where runtime validation
 * earns its keep. Tool *inputs* are validated by zod at the presentation boundary, which is
 * the only schema language the MCP SDK accepts.
 */
