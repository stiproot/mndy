/**
 * The Shopify commerce domain.
 *
 * Effect Schema is used here rather than plain types because these shapes describe data
 * arriving from the Admin API, where runtime validation is genuinely load-bearing — unlike
 * tool *inputs*, which the MCP SDK validates with zod at the presentation boundary.
 */
