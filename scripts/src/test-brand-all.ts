#!/usr/bin/env bun
/**
 * Test Brand Insights: All Sources
 *
 * Tests the brand insights endpoint with all analytics data sources
 * (GA4, Shopify, Meta) and verifies markdown report generation.
 *
 * Usage:
 *   npm run test:brand:all
 */
...
async function main() {
  ...
  console.log(`\n=== Brand Insights Test: All Sources ===`);
